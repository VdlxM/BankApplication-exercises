...
public class BankAccount {
	...
	public boolean isAmountWithdralawValid(double withdrawAmount) {
		//decision point
		return (withdrawAmount >= 0 && balance >= withdrawAmount && withdrawAmount < withdrawLimit
				&& withdrawAmount + amountWithdrawn <= withdrawLimit) ;
	
	}
	public void withdrawMoney(double withdrawAmount) {
		//decision point
		if (isAmountWithdralawValid(withdrawAmount)) {
